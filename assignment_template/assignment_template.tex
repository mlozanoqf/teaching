...
\title{Template for homework assignment reports}
...
\and
\name{An alternative for big teams, all in one line - Chick Corea
(884422), Baby Yoda (774455), Paco de Lucía (778899), Suzanne Ciani
(365411), and others.}
}

\abstract{Summary of main findings and conclusions.}

\date{Last compiled on: 05/06/2021, 06:53:43.}

\keywords{quantitative finance; financial risk; financial modeling in R}
...
\emph{Now, look how you can add a different font, this is useful for
file or function names} The original OUP sample tex document, providing
more details on preferred formatting for LaTeX documents, is included
with the template in the file \texttt{ouparticle\_sample.tex}.

Here are some sample references. \emph{Reference in brackets as in a
list} Please see (Hull 2015; Carhart 1997) for a full discussion of
multi-factor models. Bibliography will appear at the end of the
document. \emph{Second, without brackets, separated by a comma} See Hull
(2015), Cochrane (2009) for a formal demonstration of analytical
results, and (Carhart 1997; Cochrane 1996) for some empirical results.
...
Hull, John C. 2015. \emph{Options, Futures, and Other Derivatives}. 9th
ed. Prentice Hall.
